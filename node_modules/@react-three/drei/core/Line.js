...
const Line = /*#__PURE__*/React.forwardRef(function Line({
  ...
  const lineGeom = React.useMemo(() => {
    ...
    const pValues = points.map(p => p instanceof Vector3 ? [p.x, p.y, p.z] : p instanceof Vector2 ? [p.x, p.y, 0] : Array.isArray(p) && p.length === 3 ? [p[0], p[1], p[2]] : Array.isArray(p) && p.length === 2 ? [p[0], p[1], 0] : p);
