export const content = [
    ...
    },
    {
        ...
        tooltip_text: ['Click to know more and see it for yourself!'],
        text: [
            'In these systems, the brightness changes because one orbiting companion passes in front of the other. We adopt a triple system of classifying eclipsing binary systems: according to the shape of the combined light curve, as well as to physical and evolutionary characteristics of their components.',
